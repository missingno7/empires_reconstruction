...
animation-state block, GC360 ten-record table, four-flag state array, and 96-byte note-octave table are compatible symbolic TASM contributions; the 34,538-byte remainder retains the canonical anchor map.
