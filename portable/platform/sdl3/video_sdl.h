 ...
 * then present it with aspect-preserving, nearest-neighbour scaling to the
 * window.  The presentation mode is selected by sdl_video_init().
 *
...
/* Toggle borderless fullscreen (Alt+Enter); the logical presentation keeps
 * the original 320:200 aspect ratio. */
