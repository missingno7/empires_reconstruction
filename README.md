...
The build compiles 252 C regions, assembles 21 ASM
...
RGB tables (1,536 bytes); 48 raw regions cover the remaining 31,660 EXE bytes.
...
The latest [matching-C wave](docs/matching-c-wave63.md) adds a verified 53-byte
live-register note-shift routine; the latest [runtime ownership wave](docs/runtime-library-wave1.md)
identifies
