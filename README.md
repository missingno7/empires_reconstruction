...
RGB tables (1,536 bytes); seventeen raw regions cover the remaining 5,341 EXE bytes.
...
The latest [data-structure wave](docs/raw-data-wave136.md) removes 56 bytes
