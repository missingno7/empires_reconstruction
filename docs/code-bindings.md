...
462 declarations across 174 callers now refer to the selected entry publics of
219 matching C/ASM owners. Together with 72 library references and nine
structured-data references, 543 of the 1,695 declared
...
The command compiles all 260 source proof units and checks the complete EXE
...
separate `owned_component_bindings` metric is now 543. No raw bytes are promoted by
