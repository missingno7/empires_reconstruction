...
The build compiles 256 C regions, assembles 21 ASM
...
RGB tables (1,536 bytes); 43 raw regions cover the remaining 31,480 EXE bytes.
...
The latest [matching-C wave](docs/matching-c-wave67.md) adds a verified 14-byte
live-AL port-write wrapper; the latest [runtime ownership wave](docs/runtime-library-wave1.md)
identifies
