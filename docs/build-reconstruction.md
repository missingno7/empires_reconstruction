...
The EXE remains at fixed placement with declared bindings (including 213 owner-derived code/data references), 55,030 raw
bytes, and no proven reconstruction of its original source modules or historical
linker topology. Its 169 source proof units do not count as recovered original
