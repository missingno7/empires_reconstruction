...
RGB tables (1,536 bytes); eighteen raw regions cover the remaining 5,313 EXE bytes.
...
The latest [data-structure wave](docs/raw-data-wave137.md) removes 28 bytes
