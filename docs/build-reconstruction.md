...
The EXE remains at fixed placement with declared bindings (including 572 owner-derived code/data references and six owned module-data bindings), 19,296 raw
