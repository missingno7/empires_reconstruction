...
The build compiles 234 C regions, assembles 21 ASM
...
RGB tables (1,536 bytes); 56 raw regions cover the remaining 32,920 EXE bytes.
See [palette ownership and proof](docs/embedded-palettes.md).
452 code references also resolve through [owned entry publics](docs/code-bindings.md).
Another 71 resolve through [publics read from pinned library modules](docs/library-bindings.md).
The latest [matching-C wave](docs/matching-c-wave43.md) adds the 167-byte
initializer; the latest [runtime ownership wave](docs/runtime-library-wave1.md)
identifies
