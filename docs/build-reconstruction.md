...
The EXE remains at fixed placement with declared bindings (including 266 owner-derived code/data references and four owned module-data bindings), 50,792 raw
bytes, and no proven reconstruction of its original source modules or historical
linker topology. Its 210 source proof units do not count as recovered original
