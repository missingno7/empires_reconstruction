"""Fresh F_5AC3 compile and mutation control."""
...
class MatchingCWave35Tests(unittest.TestCase):
    ...
    def test_fresh_beam_walk_matches(self):
        owner = read_json(ROOT / 'recipes/c/matching-wave35.json')['owners'][0]
