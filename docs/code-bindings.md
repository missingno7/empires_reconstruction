...
458 declarations across 172 callers now refer to the selected entry publics of
217 matching C/ASM owners. Together with 72 library references and eight
structured-data references, 538 of the 1,685 declared
...
The command compiles all 258 source proof units and checks the complete EXE
...
separate `owned_component_bindings` metric is now 538. No raw bytes are promoted by
