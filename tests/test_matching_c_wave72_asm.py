"""Fresh complete-extent proof for the recovered F_D3CF ASM continuation."""
...
class MatchingCWave72AsmTests(unittest.TestCase):
    def test_recovered_tail_extent(self):
        ...
        with tempfile.TemporaryDirectory(dir=ROOT / 'build') as temporary:
            ...
            self.assertEqual(data, bytes.fromhex('c6 05 01 8b f7 83 c6 03 ac eb cf'))
