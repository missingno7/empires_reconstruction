...
73 bindings across 50 callers now reference OMF publics in 27 already owned
...
Together with 481 C/ASM entry references and nine structured-data references,
563 of 1,706 owner-symbol declarations now use component ownership. This is partial
...
layout. Raw coverage is 32,058 EXE bytes, and all three
