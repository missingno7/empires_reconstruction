...
The EXE remains at fixed placement with declared bindings (including 259 owner-derived code/data references and four owned module-data bindings), 51,022 raw
bytes, and no proven reconstruction of its original source modules or historical
linker topology. Its 209 source proof units do not count as recovered original
