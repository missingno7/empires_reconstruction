...
The build compiles 248 C regions, assembles 21 ASM
...
RGB tables (1,536 bytes); 51 raw regions cover the remaining 31,859 EXE bytes.
...
The latest [matching-C wave](docs/matching-c-wave56.md) adds a verified 6-byte
