...
The build compiles 237 C regions, assembles 21 ASM
...
RGB tables (1,536 bytes); 54 raw regions cover the remaining 32,461 EXE bytes.
See [palette ownership and proof](docs/embedded-palettes.md).
458 code references also resolve through [owned entry publics](docs/code-bindings.md).
Another 72 resolve through [publics read from pinned library modules](docs/library-bindings.md).
The latest [matching-C wave](docs/matching-c-wave46.md) adds the 56-byte
render-loop wrapper; the latest [runtime ownership wave](docs/runtime-library-wave1.md)
identifies
