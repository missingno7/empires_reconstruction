...
Wave 140 removes 22 bytes of owner-start zero-initialized data after wave 139's
...
zero runs and terminated ASCII records. The remaining raw fallback is 5,093
