...
The build compiles 217 C regions, assembles 20 ASM
...
RGB tables (1,536 bytes); 61 raw regions cover the remaining 44,028 EXE bytes.
...
The latest [C matching wave](docs/matching-c-wave25.md) adds two routines totaling 990 bytes,
including exact near-to-far pointer conversion and a complete structure-copy loop.
