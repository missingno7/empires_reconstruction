...
The build compiles 225 C regions, assembles 20 ASM
...
RGB tables (1,536 bytes); 61 raw regions cover the remaining 40,859 EXE bytes.
...
The latest [C matching wave](docs/matching-c-wave33.md) adds the 870-byte
scripted event dispatcher and binds its independently corroborated runtime
animation buffers.
