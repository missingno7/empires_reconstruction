...
The build compiles 227 C regions, assembles 20 ASM
...
RGB tables (1,536 bytes); 60 raw regions cover the remaining 39,097 EXE bytes.
...
The latest [C matching wave](docs/matching-c-wave34.md) adds the 1,762-byte
board redraw routine and binds its complete direct DGROUP references.
