...
The build compiles 257 C regions, assembles 21 ASM
...
RGB tables (1,536 bytes); 42 raw regions cover the remaining 31,412 EXE bytes.
...
The latest [matching-C wave](docs/matching-c-wave68.md) adds a verified 68-byte
far-resource-table span routine; the latest [runtime ownership wave](docs/runtime-library-wave1.md)
identifies
