...
The build compiles 149 C regions, assembles 20 ASM
...
RGB tables (1,536 bytes); 68 raw regions cover the remaining 55,030 EXE bytes.
...
The latest [C matching wave](docs/matching-c-wave2.md) adds thirteen functions and 920 bytes.
