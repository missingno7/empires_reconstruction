...
The build compiles 255 C regions, assembles 21 ASM
...
RGB tables (1,536 bytes); 44 raw regions cover the remaining 31,494 EXE bytes.
...
The latest [matching-C wave](docs/matching-c-wave66.md) adds verified 85-byte
timer-vector and PIT routines; the latest [runtime ownership wave](docs/runtime-library-wave1.md)
identifies
