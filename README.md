...
The build compiles 232 C regions, assembles 20 ASM
...
RGB tables (1,536 bytes); 55 raw regions cover the remaining 34,433 EXE bytes.
...
The latest [C matching wave](docs/matching-c-wave38.md) adds 512 bytes across
the sprite loader and cell animation routines.
