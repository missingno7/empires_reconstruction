...
RGB tables (1,536 bytes); twenty raw regions cover the remaining 8,777 EXE bytes.
...
The latest [data-structure wave](docs/raw-data-wave132.md) removes 1,274 bytes
