"""Fresh complete-extent proof for the F_7932 pointer-dispatch wrapper."""
...
class MatchingCWave47Tests(unittest.TestCase):
    def test_fresh_pointer_dispatch_extent_and_fixups(self):
        manifest = read_json(ROOT / 'layout/manifest.json')
        owner = next(r for r in manifest['regions'] if r['id'] == 'F_7932')
