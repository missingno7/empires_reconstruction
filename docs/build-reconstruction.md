...
The EXE remains at fixed placement with declared bindings (including 568 owner-derived code/data references and six owned module-data bindings), 31,981 raw
bytes, and no proven reconstruction of its original source modules or historical
linker topology. Its 263 source proof units do not count as recovered original
