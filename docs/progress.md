...
animation-state block, GC360 ten-record table, and four-flag state array are compatible symbolic TASM contributions; the 34,634-byte remainder retains the canonical anchor map.
