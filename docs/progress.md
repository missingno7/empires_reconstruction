...
Full EXE identity is preserved. Follow-ups to MVP1 remove 24,954 bytes from raw
fallback: 21,140 bytes of matching C/library regions, the 512-byte header,
...
|---|---:|---:|---:|
| Freshly compiled matching C | 14,077 | 31,341 | 229 |
...
| Exact raw fallback | 62,621 | 37,667 | 58 |
