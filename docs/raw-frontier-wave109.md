...
Wave 141 removes six alignment bytes after wave 140's 22 bytes of owner-start
zero-initialized data and wave 139's
11 bytes of isolated zero-initialized data and wave 138's
...
zero runs and terminated ASCII records. The remaining raw fallback is 5,087
bytes across sixteen owners. It consists of alignment gaps, the relocation-
backed numeric/pointer area, help control tables, player-dialog control tables,
gameplay message tables, and terminal initialized data. The current raw total is
5,087 bytes.
