...
The build compiles 136 C regions, assembles 20 ASM
...
RGB tables (1,536 bytes); 65 raw regions cover the remaining 55,950 EXE bytes.
...
The latest [C matching wave](docs/matching-c-wave1.md) adds ten functions and 291 bytes.
