...
RGB tables (1,536 bytes); twenty-one raw regions cover the remaining 8,651 EXE bytes.
...
The latest [data-structure wave](docs/raw-data-wave133.md) removes 126 bytes
