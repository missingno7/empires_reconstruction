# Historical README before the production-line migration

This snapshot is historical evidence; relative links below retain their original repository-root context.
...
including typed G43B4, C470 and GC360 record storage, while historical module ownership remains open.
