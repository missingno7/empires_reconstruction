...
The EXE remains at fixed placement with declared bindings (including 563 owner-derived code/data references and six owned module-data bindings), 32,058 raw
bytes, and no proven reconstruction of its original source modules or historical
linker topology. Its 261 source proof units do not count as recovered original
