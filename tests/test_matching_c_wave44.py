"""Fresh complete-extent proof for the F_4517 far-buffer loader."""
...
class MatchingCWave44Tests(unittest.TestCase):
    def test_fresh_far_buffer_loader_extent_and_fixups(self):
        manifest = read_json(ROOT / 'layout/manifest.json')
        owner = next(r for r in manifest['regions'] if r['id'] == 'F_4517')
        ...
        with tempfile.TemporaryDirectory(dir=ROOT / 'build') as temporary:
            ...
            self.assertEqual(len(proof['fixups']), 24)
