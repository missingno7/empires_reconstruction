...
The build compiles 329 C regions, assembles 16 ASM
...
The latest [matching-C wave](docs/matching-c-wave115.md) adds a verified 126-byte
span accumulator. The latest [runtime ownership wave](docs/runtime-library-wave1.md)
