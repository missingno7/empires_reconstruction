...
The build compiles 189 C regions, assembles 20 ASM
...
RGB tables (1,536 bytes); 69 raw regions cover the remaining 51,022 EXE bytes.
...
The latest [C matching wave](docs/matching-c-wave9.md) adds two functions and
355 code bytes, including record traversal and a timed update loop.
