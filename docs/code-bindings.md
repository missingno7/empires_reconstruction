...
461 declarations across 173 callers now refer to the selected entry publics of
218 matching C/ASM owners. Together with 72 library references and eight
structured-data references, 541 of the 1,690 declared
...
The command compiles all 259 source proof units and checks the complete EXE
...
separate `owned_component_bindings` metric is now 541. No raw bytes are promoted by
