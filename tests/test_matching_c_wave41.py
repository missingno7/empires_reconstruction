"""Fresh complete-extent proof for the F_200F initializer."""
...
class MatchingCWave41Tests(unittest.TestCase):
    def test_fresh_initializer_extent_and_fixups(self):
        manifest = read_json(ROOT / 'layout/manifest.json')
        owner = next(r for r in manifest['regions'] if r['id'] == 'F_200F')
        ...
        with tempfile.TemporaryDirectory(dir=ROOT / 'build') as temporary:
            ...
            self.assertEqual(len(proof['fixups']), 30)
