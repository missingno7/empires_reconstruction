...
The EXE remains at fixed placement with declared bindings (including 289 owner-derived code/data references and four owned module-data bindings), 49,692 raw
bytes, and no proven reconstruction of its original source modules or historical
linker topology. Its 216 source proof units do not count as recovered original
