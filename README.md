...
The build compiles 331 C regions, assembles 14 ASM
...
The latest [matching-C wave](docs/matching-c-wave117.md) adds a verified 74-byte
far rectangle-queue drain. The latest [runtime ownership wave](docs/runtime-library-wave1.md)
