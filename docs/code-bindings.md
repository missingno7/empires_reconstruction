...
489 declarations across 157 callers now refer to the selected entry publics of
228 matching C/ASM owners. Together with 75 library bindings and nine
structured-data references, 573 of the 1,727 declared
...
The command compiles all 270 source proof units and checks the complete EXE
...
separate `owned_component_bindings` metric is now 572. No raw bytes are promoted by
