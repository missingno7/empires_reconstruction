...
The EXE remains at fixed placement with declared bindings (including 380 owner-derived code/data references and four owned module-data bindings), 43,597 raw
bytes, and no proven reconstruction of its original source modules or historical
linker topology. Its 240 source proof units do not count as recovered original
