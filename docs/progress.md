...
| Exact raw fallback | 62,621 | 5,126 | 17 |
...
DAT payloads and 5,126 raw EXE bytes remain temporary fallbacks. See
...
The raw frontier is now 5,126 bytes across 17 owners.
