...
The build compiles 242 C regions, assembles 21 ASM
...
RGB tables (1,536 bytes); 52 raw regions cover the remaining 31,981 EXE bytes.
...
The latest [matching-C wave](docs/matching-c-wave52.md) adds a verified 42-byte
