...
The build compiles 243 C regions, assembles 21 ASM
...
RGB tables (1,536 bytes); 52 raw regions cover the remaining 31,952 EXE bytes.
See [palette ownership and proof](docs/embedded-palettes.md).
484 code references also resolve through [owned entry publics](docs/code-bindings.md).
Another 75 resolve through [publics read from pinned library modules](docs/library-bindings.md).
The latest [matching-C wave](docs/matching-c-wave53.md) adds a verified 29-byte
