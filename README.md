...
The build compiles 254 C regions, assembles 21 ASM
...
RGB tables (1,536 bytes); 46 raw regions cover the remaining 31,579 EXE bytes.
...
The latest [matching-C wave](docs/matching-c-wave65.md) adds a verified 75-byte
display-mode and VGA probe routine; the latest [runtime ownership wave](docs/runtime-library-wave1.md)
identifies
