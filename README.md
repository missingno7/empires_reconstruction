...
The build compiles 230 C regions, assembles 20 ASM
...
RGB tables (1,536 bytes); 57 raw regions cover the remaining 34,945 EXE bytes.
...
The latest [C matching wave](docs/matching-c-wave37.md) adds the 2,722-byte
turn loop and binds its complete neighboring state and table references.
