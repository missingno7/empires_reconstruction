...
The EXE remains at fixed placement with declared bindings (including 365 owner-derived code/data references and four owned module-data bindings), 44,028 raw
