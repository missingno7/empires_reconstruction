...
481 declarations across 150 callers now refer to the selected entry publics of
224 matching C/ASM owners. Together with 73 library bindings and nine
structured-data references, 563 of the 1,706 declared
...
The command compiles all 261 source proof units and checks the complete EXE
...
separate `owned_component_bindings` metric is now 563. No raw bytes are promoted by
