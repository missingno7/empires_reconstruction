...
animation-state block, GC360 ten-record table, four-flag state array, and paired 96-byte note tables are compatible symbolic TASM contributions; the 34,442-byte remainder retains the canonical anchor map.
