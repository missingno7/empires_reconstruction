...
The build compiles 232 C regions, assembles 21 ASM
...
451 code references also resolve through [owned entry publics](docs/code-bindings.md).
Another 70 resolve through [publics read from pinned library modules](docs/library-bindings.md).
The latest [matching-C wave](docs/matching-c-wave41.md) adds the 266-byte
