...
The build compiles 233 C regions, assembles 21 ASM
...
RGB tables (1,536 bytes); 56 raw regions cover the remaining 33,231 EXE bytes.
...
The latest [matching-C wave](docs/matching-c-wave42.md) adds the 144-byte
