...
The EXE remains at fixed placement with declared bindings (including 233 owner-derived code/data references and three owned module-data bindings), 53,785 raw
bytes, and no proven reconstruction of its original source modules or historical
linker topology. Its 183 source proof units do not count as recovered original
