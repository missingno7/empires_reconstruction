...
The build compiles 190 C regions, assembles 20 ASM
...
RGB tables (1,536 bytes); 69 raw regions cover the remaining 50,792 EXE bytes.
...
The latest [C matching wave](docs/matching-c-wave10.md) adds one function and
203 code bytes, unblocked by 27 bytes of independently encoded text.
