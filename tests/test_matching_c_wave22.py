"""Full fresh comparisons and expression/layout mutants for the twenty-second C wave."""
import copy
...
class MatchingCWave22Tests(unittest.TestCase):
    def test_fresh_wave_and_expression_layout_mutants(self):
        manifest = read_json(ROOT / 'layout/manifest.json')
        owners = read_json(ROOT / 'recipes/c/matching-wave22.json')['owners']
