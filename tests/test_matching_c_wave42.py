"""Fresh complete-extent proof for the F_2119 far-buffer copy loop."""
...
class MatchingCWave42Tests(unittest.TestCase):
    def test_fresh_far_copy_extent_and_fixups(self):
        manifest = read_json(ROOT / 'layout/manifest.json')
        owner = next(r for r in manifest['regions'] if r['id'] == 'F_2119')
