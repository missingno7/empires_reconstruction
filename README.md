...
The build compiles 244 C regions, assembles 21 ASM
...
RGB tables (1,536 bytes); 52 raw regions cover the remaining 31,931 EXE bytes.
...
The latest [matching-C wave](docs/matching-c-wave54.md) adds a verified 21-byte
