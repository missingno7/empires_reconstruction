...
The build compiles 215 C regions, assembles 20 ASM
...
RGB tables (1,536 bytes); 62 raw regions cover the remaining 45,018 EXE bytes.
...
The latest [C matching wave](docs/matching-c-wave24.md) adds two routines totaling 866 bytes,
including four traversal cases and exact pointer-offset instruction selection.
