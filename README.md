...
The build compiles 161 C regions, assembles 20 ASM
...
RGB tables (1,536 bytes); 73 raw regions cover the remaining 54,194 EXE bytes.
...
The latest [C matching wave](docs/matching-c-wave3.md) adds twelve functions and
821 code bytes, plus a 15-byte initializer generated from the same C source.
