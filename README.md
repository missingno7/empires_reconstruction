...
The build compiles 211 C regions, assembles 20 ASM
...
RGB tables (1,536 bytes); 63 raw regions cover the remaining 46,579 EXE bytes.
...
The latest [C matching wave](docs/matching-c-wave21.md) adds three routines totaling 363 bytes,
unblocked by independently verified indexed storage-base evidence.
