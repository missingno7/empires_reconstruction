...
label to preserve its split boundary and has no external fixups or loader
relocations. `F_DF98` from the adjacent span is tracked separately in wave
103 because it has library far-call relocations.
