"""Fresh complete-extent proof for the recovered F_53BF display-mode C routine."""
...
class MatchingCWave65Tests(unittest.TestCase):
    def test_recovered_complete_extent_and_fixups(self):
        ...
        recipe = read_json(ROOT / 'recipes/c/matching-wave65.json')
        owner = next(r for r in manifest['regions'] if r['id'] == 'F_53BF')
        self.assertEqual(next(r for r in recipe['owners'] if r['id'] == 'F_53BF'), owner)
