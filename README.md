...
The build compiles 249 C regions, assembles 21 ASM
...
RGB tables (1,536 bytes); 51 raw regions cover the remaining 31,798 EXE bytes.
...
The latest [matching-C wave](docs/matching-c-wave57.md) adds a verified 61-byte
