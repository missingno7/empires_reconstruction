...
void f039c()
{
    ...
    asm db 0fbh,000h,074h,009h,024h,0f0h,026h,080h,025h,00fh,026h,008h,005h,05fh,05dh,0c3h
    /* F_03A5: adjacent planar-bar variant with mirrored nibble handling. */
    asm runtime_f03a5:
    asm push bp
    asm mov bp,sp
    asm db 057h
    ...
    /* F_03AB / fill: planar XOR-fill primitive. */
    asm runtime_f03ab:
    asm push bp
    asm mov bp,sp
    asm db 057h,056h
    ...
    asm db 0b8h,0a0h,000h,02bh,0c3h,08bh,0cbh,0f3h,0a4h,003h,0f8h,04ah,075h,0f7h,01fh,05eh,05fh,05dh,0c3h
    /* F_03B4 / wipe: planar rectangle copy with word-aligned interior. */
    asm runtime_f03b4:
    asm push bp
    asm mov bp,sp
    asm db 057h,056h
    ...
    asm db 0f3h,02bh,0f8h,02bh,0fbh,04ah,075h,0f1h,01fh,05eh,05fh,05dh,0c3h
    /* F_03BA: reverse-direction planar nibble transform. */
    asm runtime_f03ba:
    asm push bp
    asm mov bp,sp
    asm db 057h,056h
    ...
    asm shr bx,1
    asm mov dx,[bp+0ah]
    asm db 003h,0fbh,04fh,08bh,0cbh,0ach,0d0h,0c0h
    ...
    asm db 04ah,075h,0e0h,01fh,05eh,05fh,05dh,0c3h
    /* F_03BD: mirrored reverse-direction planar nibble transform. */
    asm runtime_f03bd:
    asm push bp
    asm mov bp,sp
    asm db 057h,056h
    ...
    asm shr bx,1
    asm mov dx,[bp+0ah]
    asm db 08bh,0c2h,048h,086h,0e0h,0d1h,0e8h,003h,0f8h,0d1h,0e8h,0d1h,0e8h
    ...
    asm db 0a0h,000h,02bh,0f3h,081h,0efh,0a0h,000h,003h,0fbh,04ah,075h,0e0h,01fh,05eh,05fh,05dh,0c3h
    /* F_03C0: dual-planar reflected pixel transform. */
    asm runtime_f03c0:
    asm push bp
    asm mov bp,sp
    asm db 057h,056h
