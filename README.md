...
The build compiles 260 C regions, assembles 21 ASM
...
RGB tables (1,536 bytes); 41 raw regions cover the remaining 31,298 EXE bytes.
...
far-record decoder main routine; the latest [runtime ownership wave](docs/runtime-library-wave1.md)
identifies
