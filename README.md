...
The build compiles 219 C regions, assembles 20 ASM
...
RGB tables (1,536 bytes); 62 raw regions cover the remaining 43,669 EXE bytes.
...
The latest [C matching wave](docs/matching-c-wave28.md) adds one routine totaling 113 bytes,
including an independently proved DS:96EE runtime-buffer binding.
