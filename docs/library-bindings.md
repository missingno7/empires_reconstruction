...
38 bindings across 23 callers now reference OMF publics in 17 already owned
...
Together with 151 C/ASM entry references and two palette references, 191 of
787 owner-symbol declarations now use component ownership. This is partial
...
layout. Raw coverage remains unchanged at 56,241 EXE bytes, and all three
