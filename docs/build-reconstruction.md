...
The EXE remains at fixed placement with declared bindings (including 572 owner-derived code/data references and six owned module-data bindings), 31,859 raw
bytes, and no proven reconstruction of its original source modules or historical
linker topology. Its 269 source proof units do not count as recovered original
