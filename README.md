...
The build compiles 260 C regions, assembles 22 ASM
...
RGB tables (1,536 bytes); 41 raw regions cover the remaining 31,287 EXE bytes.
...
far-record decoder main routine; the latest ASM wave closes its 11-byte
branch continuation. the latest [runtime ownership wave](docs/runtime-library-wave1.md)
identifies
