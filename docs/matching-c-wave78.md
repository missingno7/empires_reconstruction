...
and was recovered as a complete matching-C component. It allocates the historical
...
The canonical source is now symbolic TASM for the exact BIOS register and
stack-buffer sequence. It emits all 66 bytes with one DGROUP fixup for the
