...
The build compiles 229 C regions, assembles 20 ASM
...
RGB tables (1,536 bytes); 58 raw regions cover the remaining 37,667 EXE bytes.
...
The latest [C matching wave](docs/matching-c-wave36.md) adds the 449-byte
selection routine and binds its original pooled strings.
