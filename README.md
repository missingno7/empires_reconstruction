...
The build compiles 228 C regions, assembles 20 ASM
...
RGB tables (1,536 bytes); 59 raw regions cover the remaining 38,116 EXE bytes.
...
The latest [C matching wave](docs/matching-c-wave35.md) adds the 981-byte beam
walk and binds its complete board and sprite state references.
