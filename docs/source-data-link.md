...
declares an ordered 34-byte symbolic prefix, the 1,952-byte `F_0281` row-pointer
table, a 16-byte shared command/render state island, the ten-record C470
table, and 34,978 bytes of anchored aggregate storage covering the verified
reserve and its currently recovered public map. Independent runtime fixups verify its boundary;
