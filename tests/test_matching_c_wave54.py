"""Fresh complete-extent proof for the recovered F_D45C wrapper."""
...
class MatchingCWave54Tests(unittest.TestCase):
    def test_recovered_complete_extent_and_fixups(self):
        manifest = read_json(ROOT / 'layout/manifest.json')
        recipe = read_json(ROOT / 'recipes/c/matching-wave54.json')
        owner = next(r for r in manifest['regions'] if r['id'] == 'F_D45C')
        recipe_owner = next(r for r in recipe['owners'] if r['id'] == 'F_D45C')
