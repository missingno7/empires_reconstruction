...
The build compiles 184 C regions, assembles 20 ASM
...
RGB tables (1,536 bytes); 68 raw regions cover the remaining 51,801 EXE bytes.
...
The latest [C matching wave](docs/matching-c-wave7.md) adds five functions and
756 code bytes, plus 16 bytes of compiler-owned static strings.
