...
The build compiles 258 C regions, assembles 21 ASM
...
RGB tables (1,536 bytes); 42 raw regions cover the remaining 31,404 EXE bytes.
...
The latest [matching-C wave](docs/matching-c-wave69.md) adds a verified 8-byte
DOS write helper; the latest [runtime ownership wave](docs/runtime-library-wave1.md)
identifies
