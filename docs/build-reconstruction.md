...
The EXE remains at fixed placement with declared bindings (including 201 owner-derived code/data references), 55,950 raw
bytes, and no proven reconstruction of its original source modules or historical
linker topology. Its 156 source proof units do not count as recovered original
