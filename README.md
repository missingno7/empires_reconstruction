...
The build compiles 218 C regions, assembles 20 ASM
...
RGB tables (1,536 bytes); 60 raw regions cover the remaining 43,782 EXE bytes.
...
The latest [C matching wave](docs/matching-c-wave27.md) adds one routine totaling 246 bytes,
including an exact historical switch-table layout and answer-dialog dispatcher.
