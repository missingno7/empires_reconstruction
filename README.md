...
The build compiles 187 C regions, assembles 20 ASM
...
RGB tables (1,536 bytes); 68 raw regions cover the remaining 51,377 EXE bytes.
...
The latest [C matching wave](docs/matching-c-wave8.md) adds three functions and
424 code bytes, preserving pointer conversion and register-allocation details.
