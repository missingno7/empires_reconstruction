...
def audit(root=ROOT):
    ...
    resolutions = [
        ...
        {'id':'GLOBAL_TYPE:gbfc4','outcome':'UNIFIED','resolution':'unsigned char far *gbfc4: src/TURNLOOP.C (previously char far *, dereferenced only as `*gbfc4 != 0`) now matches src/BRDPAINT.C. F_3A75 probe: EXACT. (src/F_D386.C\'s char far * declaration is an inactive reference source -- the TASM module M_D386_D3CF is what actually builds -- and was left untouched.)'},
