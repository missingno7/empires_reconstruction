...
452 declarations across 172 callers now refer to the selected entry publics of
215 matching C/ASM owners. Together with 71 library references and eight
structured-data references, 531 of the 1,650 declared
...
The command compiles all 254 source proof units and checks the complete EXE
...
separate `owned_component_bindings` metric is now 531. No raw bytes are promoted by
