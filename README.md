...
The build compiles 179 C regions, assembles 20 ASM
...
RGB tables (1,536 bytes); 68 raw regions cover the remaining 52,573 EXE bytes.
...
The latest [C matching wave](docs/matching-c-wave6.md) adds six functions and
670 code bytes, including pointer loops and an exact compiler-generated switch table.
