...
Full EXE identity is preserved. Follow-ups to MVP1 remove 32,873 bytes from raw
...
|---|---:|---:|---:|
| Freshly compiled matching C | 14,077 | 39,587 | 276 |
...
| Exact raw fallback | 62,621 | 28,165 | 33 |
...
DAT payloads and 28,165 raw EXE bytes remain temporary fallbacks. See
