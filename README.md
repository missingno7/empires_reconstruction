...
RGB tables (1,536 bytes); seventeen raw regions cover the remaining 5,126 EXE bytes.
...
The latest [data-structure wave](docs/raw-data-wave138.md) removes 187 bytes
