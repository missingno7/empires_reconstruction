...
RGB tables (1,536 bytes); eighteen raw regions cover the remaining 5,115 EXE bytes.
...
The latest [data-structure wave](docs/raw-data-wave139.md) removes 11 bytes
