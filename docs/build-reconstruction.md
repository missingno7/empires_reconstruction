...
The fixed EXE remains the byte-identical oracle with declared bindings and zero
raw bytes, but no complete reconstruction of its original source modules. The
