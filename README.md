...
The build compiles 247 C regions, assembles 21 ASM
...
RGB tables (1,536 bytes); 51 raw regions cover the remaining 31,865 EXE bytes.
...
The latest [matching-C wave](docs/matching-c-wave55.md) adds a verified 66-byte
