...
482 declarations across 151 callers now refer to the selected entry publics of
224 matching C/ASM owners. Together with 74 library bindings and nine
structured-data references, 565 of the 1,710 declared
...
The command compiles all 262 source proof units and checks the complete EXE
...
separate `owned_component_bindings` metric is now 565. No raw bytes are promoted by
