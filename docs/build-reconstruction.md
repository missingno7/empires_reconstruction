...
The EXE remains at fixed placement with declared bindings (including 225 owner-derived code/data references and one owned module-data binding), 54,194 raw
bytes, and no proven reconstruction of its original source modules or historical
linker topology. Its 181 source proof units do not count as recovered original
